...
(function (scenes) {
    ...
    var Controls = (function (_super) {
        ...
        Controls.prototype.start = function () {
            this._gameLabel = new createjs.Text("INSTRUCTIONS", "60px 'Press Start 2P'", "#000000");
            ...
            //move instructions
            this._moveLabel = new createjs.Text("use WASD (or arrow keys) to move your player", "15px 'Press Start 2P'", "#000000");
            ...
            //jump instructions
            this._jumpLabel = new createjs.Text("use the SPACEBAR to jump", "15px 'Press Start 2P'", "#000000");
            ...
            //aim instructions
            this._aimLabel = new createjs.Text("move your MOUSE to aim", "15px 'Press Start 2P'", "#000000");
            ...
            //avoid instructions
            this._avoidLabel = new createjs.Text("avoid oncoming projectiles", "15px 'Press Start 2P'", "#000000");
            ...
            this._objectiveLabel = new createjs.Text("reach the green cube to win", "15px 'Press Start 2P'", "#000000");
            ...
            this._coinTextLabel = new createjs.Text("collect coins to score points", "15px 'Press Start 2P'", "#000000");
