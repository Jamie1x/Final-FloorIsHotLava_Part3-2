...
(function (scenes) {
    ...
    var Controls = (function (_super) {
        ...
        Controls.prototype.start = function () {
            ...
            //move instructions
            this._moveLabel = new createjs.Text("use WASD (or arrow keys) to move your player", "20px Comic Sans MS", "#ff0000");
            ...
            //jump instructions
            this._jumpLabel = new createjs.Text("use the SPACEBAR to jump", "20px Comic Sans MS", "#ff0000");
            ...
            //aim instructions
            this._aimLabel = new createjs.Text("move your MOUSE to aim", "20px Comic Sans MS", "#ff0000");
            ...
            //avoid instructions
            this._avoidLabel = new createjs.Text("avoid oncoming projectiles", "20px Comic Sans MS", "#ff0000");
